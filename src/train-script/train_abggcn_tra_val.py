...
for epoch in range(num_epochs):
    ...
    if pre_epoch is not None : 
        print(f'epoch: {pre_epoch+1+epoch}\ttime: {m:.0f}m {s:.0f}s\ntrain loss={train_losses:.3f}\tvalid_loss={valid_losses:.3f}') 
        print(f'train att loss={train_att_losses:.3f}   train pctr loss={train_pctr_losses:.3f}   valid att loss={valid_att_losses:.3f}   valid pctr loss={valid_pctr_losses:.3f}')
    else : 
        print(f'epoch: {epoch}\ttime: {m:.0f}m {s:.0f}s\ntrain loss={train_losses:.3f}\ttest_loss={valid_losses:.3f}')
        print(f'train att loss={train_att_losses:.3f}   train pctr loss={train_pctr_losses:.3f}   valid att loss={valid_att_losses:.3f}   valid pctr loss={valid_pctr_losses:.3f}')
